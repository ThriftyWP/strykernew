...
jQuery(document).ready(function($){
    ...
    //link disable 
    if( wcqv_frontend_obj.disable_links == '1' ){
    ...
    $(document).on('click', ".img_quick_view", function() {

        var product_id = $(this).data('product-id');
        wcqv_get_product_details(product_id);
        $(this).append('<div class="img-spinner"></div>');

        return false;
    });

     //shop page icon click 
    $(document).on('click', ".quick_view_icon", function() {
