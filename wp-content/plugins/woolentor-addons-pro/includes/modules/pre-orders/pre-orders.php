...
class Woolentor_Pre_Orders{
    ...
    public function __construct(){
        ...
        if( is_admin() ){
            Woolentor_Admin_Pre_Orders::instance();
        }

        // Add To cart button manager
        Woolentor_Pre_Order_AddTo_Cart::instance();

        // Price manager
        Woolentor_Pre_Order_Price::instance();

        // Pre-Order Content manager
        Woolentor_Pre_Order_Content::instance();

        // Order manager
        Woolentor_Pre_Order_Place::instance();
    ...
    public function admin_enqueue_scripts(){
        //Script
        wp_enqueue_script( 'woolenor-admin-pre-order', plugin_dir_url( __FILE__ ) . 'assets/js/admin-pre-order.js', array('jquery'), WOOLENTOR_VERSION, true );
    }
    ...
    public function enqueue_scripts(){
        ...
        //Script
        wp_enqueue_script( 'woolenor-pre-order', plugin_dir_url( __FILE__ ) . 'assets/js/pre-order.js', array('countdown-min'), WOOLENTOR_VERSION, true );
    }
