    ...
    */
    public function field_types() {
        $field_type_list = [
            ...
            'datetime_local' => esc_html__( 'Datetime local', 'woolentor-pro' ),
            'time'           => esc_html__( 'Time', 'woolentor-pro' ),
            'month'          => esc_html__( 'Month', 'woolentor-pro' ),
            'week'           => esc_html__( 'Week', 'woolentor-pro' ),
        ];
        ...
        if( is_array( $ofields ) && !empty( $ofields ) ) {
            ...
            foreach( $ofields as $name => $field ) {
                ...
                if( isset( $new_field['label'] ) ){
                    ...
                    $new_field['label'] = esc_html( woolentor_translator_pro('woolentor_field_label_'.$name, $new_field['label']) );
                }

                if( isset( $new_field['placeholder'] ) ){
                    // $new_field['placeholder'] = esc_html__( $new_field['placeholder'], 'woolentor-pro' );
                    $new_field['placeholder'] = esc_html( woolentor_translator_pro('woolentor_field_placeholder_'.$name, $new_field['placeholder']) );
                }
