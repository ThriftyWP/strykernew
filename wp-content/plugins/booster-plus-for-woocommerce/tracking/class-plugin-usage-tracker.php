 ...
 *
 * @version 6.0.0
 * @package Booster_Plus_For_WooCommerce/tracking
 */
	...
	class Plugin_Usage_Tracker {
		...
		public function marketing_notice() {
			...
			if ( $wpnonce && isset( $_GET['marketing_optin'] ) ) {
				...
				// Do tracking.
				$this->do_tracking( true );
			} elseif ( ( isset( $_GET['marketing_optin'] ) && 'yes' === $_GET['marketing_optin'] ) || ( isset( $_GET['marketing_optin'] ) && 'yes' === $_GET['marketing_optin'] ) ) {
